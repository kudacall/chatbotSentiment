...
guess = ['Hmm. How interesting. According to my memory and calculations, I lack ' stringScore ' ' 'percent confidence in my classification algorithm.'];
speech(guess)
disp(guess)
...
confirmQ = ['Your response was ' classifyA ' ' 'and the words I should add to my memory are above.  Is this correct?  Answer yes or no:' ' '];
